...
void test_evaluate_empty_deques() {
  // Expression: (empty)
  std::deque<int> numbers;
  std::deque<char> operators;
  int result = evaluate(numbers, operators);
  assert(result == 0);
  std::cout << "✓ test_evaluate_empty_deques passed\n";
}

void test_evaluate_single_addition() {
  // Expression: 5+3
  std::deque<int> numbers{5, 3};
  std::deque<char> operators{'+'};
  int result = evaluate(numbers, operators);
...
void test_evaluate_mixed_operations() {
  ...
  std::deque<int> numbers{12, 34, 5, 6, 2};
  std::deque<char> operators{'+', '-', '*', '/'};
  int result = evaluate(numbers, operators);
  assert(result == 31);
...
void test_evaluate_complex_expression() {
  ...
  std::deque<int> numbers{5, 3, 2, 4, 1};
  std::deque<char> operators{'+', '*', '-', '/'};
  int result = evaluate(numbers, operators);
  assert(result == 7);
...
void test_evaluate_large_numbers() {
  ...
  std::deque<int> numbers{1000, 500, 2};
  std::deque<char> operators{'+', '*'};
  int result = evaluate(numbers, operators);
  assert(result == 2000);
...
void test_evaluate_with_opening_parenthesis() {
  ...
  int result = evaluate(numbers, operators);
  assert(result == 5);
  std::cout << "✓ test_evaluate_with_opening_parenthesis passed (result: " << result << ")\n";
}
...
//   std::deque<char> operators{')', '+'};
//   int result = evaluate(numbers, operators);
//   std::cout << "✓ test_evaluate_with_closing_parenthesis passed (result: " << result << ")\n";
// }
...
void test_evaluate_parenthesis_simple_addition() {
  ...
  int result = evaluate(numbers, operators);
  assert(result == 5);
  std::cout << "✓ test_evaluate_parenthesis_simple_addition passed (result: " << result << ")\n";
}
...
void test_evaluate_parenthesis_with_multiplication() {
  ...
  int result = evaluate(numbers, operators);
  assert(result == 20);
  std::cout << "✓ test_evaluate_parenthesis_with_multiplication passed (result: " << result << ")\n";
}
...
void test_evaluate_multiple_parenthesis_groups() {
  // Expression: (2+3)*(4+5)
  std::deque<int> numbers{2, 3, 4, 5};
  std::deque<char> operators{'(', '+', ')', '*', '(', '+', ')'};
  int result = evaluate(numbers, operators);
  assert(result == 45);
  std::cout << "✓ test_evaluate_multiple_parenthesis_groups passed (result: " << result << ")\n";
}
...
void test_evaluate_parenthesis_with_subtraction() {
  // Expression: (10-3)*2
  std::deque<int> numbers{10, 3, 2};
  std::deque<char> operators{'(', '-', ')', '*'};
  int result = evaluate(numbers, operators);
  assert(result == 14);
  std::cout << "✓ test_evaluate_parenthesis_with_subtraction passed (result: " << result << ")\n";
}

void test_evaluate_parenthesis_with_division() {
  // Expression: (20/4)+3
  std::deque<int> numbers{20, 4, 3};
  std::deque<char> operators{'(', '/', ')', '+'};
  int result = evaluate(numbers, operators);
  assert(result == 8);
  std::cout << "✓ test_evaluate_parenthesis_with_division passed (result: " << result << ")\n";
}
...
void test_evaluate_deeply_nested_parenthesis() {
  ...
  int result = evaluate(numbers, operators);
  assert(result == 15);
  std::cout << "✓ test_evaluate_deeply_nested_parenthesis passed (result: " << result << ")\n";
}
...
void test_evaluate_parenthesis_mixed_precedence() {
  ...
  int result = evaluate(numbers, operators);
  assert(result == 29);
  std::cout << "✓ test_evaluate_parenthesis_mixed_precedence passed (result: " << result << ")\n";
}

void test_evaluate_parenthesis_complex_nested() {
  // Expression: ((2+3)*(4-1))/5
  std::deque<int> numbers{2, 3, 4, 1, 5};
  std::deque<char> operators{'(', '(', '+', ')', '*', '(', '-', ')', ')', '/'};
  int result = evaluate(numbers, operators);
  assert(result == 3);
  std::cout << "✓ test_evaluate_parenthesis_complex_nested passed (result: " << result << ")\n";
}
...
void test_evaluate_parenthesis_single_number() {
  ...
  int result = evaluate(numbers, operators);
  assert(result == 5);
  std::cout << "✓ test_evaluate_parenthesis_single_number passed (result: " << result << ")\n";
}
...
void test_evaluate_parenthesis_consecutive_groups() {
  ...
  int result = evaluate(numbers, operators);
  assert(result == 25);
  std::cout << "✓ test_evaluate_parenthesis_consecutive_groups passed (result: " << result << ")\n";
}

void test_evaluate_parenthesis_subtraction_division() {
  // Expression: (10-2)/(4-2)
  std::deque<int> numbers{10, 2, 4, 2};
  std::deque<char> operators{'(', '-', ')', '/', '(', '-', ')'};
  int result = evaluate(numbers, operators);
  assert(result == 4);
  std::cout << "✓ test_evaluate_parenthesis_subtraction_division passed (result: " << result << ")\n";
}

int main() {
  std::cout << "Running unit tests for evaluate function...\n\n";

  test_evaluate_empty_deques();
